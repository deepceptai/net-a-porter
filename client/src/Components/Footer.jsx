...
import Ameri from '../../public/Images/Amex.svg';
import Jcb from '../../public/Images/jcb.svg';
import UnionPay from '../../public/Images/UnionPay.svg';
import Delta from '../../public/Images/delta.svg';
import Applepay from '../../public/Images/applePay.svg';
import Klama from '../../public/Images/klarna.svg';
          ...
          <div className="col-lg-6 mb-4">
            ...
            <div className="d-flex align-items-start gap-3 mb-4">
              <div className="footer-qr">
                <img src="https://www.net-a-porter.com/content/images/cms/ycm/resource/blob/2208824/ac0ee0a244487aee4547526b6609df41/nap-qrcode-footer-data.svg" alt="qr code" className='img-fluid h-100' />
              </div>
            ...
            <div className="d-flex flex-wrap gap-2 footer-payment-icons">
              ...
              <div className="payment-icon">
                <img src={Ameri} alt="American Express" />
              </div>
